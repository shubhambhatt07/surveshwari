                        ...
                        <div class="col-lg-6 col-md-6">
                            <ul class="payment-types">
                               ...
                               <!--  <li>
                                ...
                                <li>
                                    <a href="#" target="_blank"><img src="<?=base_url()?>assets/img/payment/mastercard2.png" alt="image"></a>
                                </li>
                                <li>
                                    <a href="#" target="_blank"><img src="<?=base_url()?>assets/img/payment/visa2.png" alt="image"></a>
                                </li>
                                <li>
