...
<!-- Mirrored from templates.envytheme.com/xenoz/default/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Oct 2020 05:44:51 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="product-thumbnail">
                                                <a href="#">
                                                    <img src="assets/img/lookbook/lookbook1.jpg" alt="item">
                                                </a>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="product-thumbnail">
                                                <a href="#">
                                                    <img src="assets/img/lookbook/lookbook2.jpg" alt="item">
                                                </a>
                                            </td>
                                            <td class="product-name">
                                        ...
                                        <tr>
                                            <td class="product-thumbnail">
                                                <a href="#">
                                                    <img src="assets/img/lookbook/lookbook3.jpg" alt="item">
                                                </a>
                                            </td>
                                            <td class="product-name">
                                        ...
                                        <tr>
                                            <td class="product-thumbnail">
                                                <a href="#">
                                                    <img src="assets/img/lookbook/lookbook4.jpg" alt="item">
                                                </a>
                                            </td>
                                            <td class="product-name">
