...
<!-- Mirrored from templates.envytheme.com/xenoz/default/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Oct 2020 05:44:43 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
    ...
    <body>
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item"><a href="index-2.html" class="nav-link">Jewelry Home</a></li>
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <ul class="megamenu-submenu">
                                                            <li><a href="gallery-1.html">Grid (3 in Row)</a></li>

                                                            <li><a href="gallery-2.html">Grid Full Width (4 in Row)</a></li>

                                                            <li><a href="gallery-3.html">Grid (2 in Row)</a></li>
                                                        </ul>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            <span>About Us</span>
                            <h3>Xenoz Trusted Online Shopping Site in the World</h3>
        ...
        <!-- Start Clients Area -->
        <section class="clients-area pb-70">
            <div class="container">
                <div class="section-title">
                    <p>Testimonial</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="clients-item">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliq. Quis ipsum suspendisse ultrice</p>
                            <ul class="star-list">
                                <li>
...
<!-- Mirrored from templates.envytheme.com/xenoz/default/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Oct 2020 05:44:44 GMT -->
</html>